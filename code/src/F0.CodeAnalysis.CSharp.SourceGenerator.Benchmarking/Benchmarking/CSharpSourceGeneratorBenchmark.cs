...
public sealed class CSharpSourceGeneratorBenchmark<TSourceGenerator>
	where TSourceGenerator : ISourceGenerator, new()
{
	...
	public CSharpSourceGeneratorBenchmark()
	{
	...
	internal TSourceGenerator Generator { get; }

	public void Initialize(CSharpSourceGeneratorBenchmarkInitializationContext context)
	{
		...
		driver = CSharpGeneratorDriver.Create(generators, additionalTexts, parseOptions, optionsProvider);
	...
	public void Inspect(CSharpSourceGeneratorBenchmarkInspectionContext context)
	{
		_ = context ?? throw new ArgumentNullException(nameof(context));
	...
	private static Compilation CreateCompilation(CSharpSourceGeneratorBenchmarkInitializationContext context, out ImmutableArray<Location> locations)
	{
